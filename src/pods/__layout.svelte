<script>
    ...
    import { user, isLoggedIn } from "../core/stores/user.js";
    import { auth } from "../core/Authentication/firebase.js";
...
<nav class="bg-neutral-800 p-4 text-white">
    <div class="container m-auto">
        <ul class="flex">
            <li class="mr-6">
                <a href="/public" class="text-blue-500 hover:text-blue-800">home</a>
            </li>
            {#if $isLoggedIn}
                <li class="mr-6">
